...
> This is your live, editable checklist. `appendices/G-progress-tracker.md` is the copy kept inside the reference bundle — update this file as you go and mirror the level checkboxes back into `ROADMAP.md` Appendix G occasionally if you want ROADMAP.md to stay in sync (not required).
